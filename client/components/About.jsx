  ...
  return (
    <div className='h-96 w-full relative px-10'>
      ...
      <p className='font-bold'>"In our <span className='bg-dark-secondary-500 px-2 italic'>e-learning platform</span>, we are dedicated to providing an enriching and accessible educational experience for all. We offer a wide range of free courses that cover various topics and disciplines, allowing you to acquire valuable knowledge and skills from the comfort of your home.
        ...
        <br/>
        <br/>
        <span className='bg-dark-secondary-500 px-2 italic'>Our virtual campus</span> is an interactive and user-friendly environment designed to provide an immersive learning experience. Here, you will find educational resources, study materials, assessments, and progress tracking tools that will help you make the most of your study time.
        ...
        <br/>
        <br/>
        <span className='bg-dark-secondary-500 px-2 italic'>In Summery</span>  our e-learning platform is the perfect place for those who want to learn flexibly and conveniently. Whether you're looking to expand your knowledge, attend engaging events, explore our virtual campus, or connect with a vibrant learning community, we have everything you need to embark on your educational journey."</p>
    </div >
  )
}
