...
const Links = ["home", "aboutUs", "clases", "chat", "contact"]

export const Navbar = () => {
  return (
    <div className='flex items-center justify-between p-4  h-14 w-full bg-light-primary-500 shadow-xl '>
      ...
      <div className='flex '>
        ...
        <Link href={`/auth/login`} className='-skew-y-6 rotate-6 text-xl uppercase px-3 bg-dark-primary-800 text-dark-secondary-300  hover:brightness-125'>
          Register
        </Link>
      </div>
    </div>
